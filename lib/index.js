 ...
 */
function applyEnhancedWebSearchTool(ctx, maxResults, timeoutMs, fetchEnabled, searxng) {
...
export function apply(ctx, config) {
    ...
    if (resolved.search) {
        applyEnhancedWebSearchTool(ctx, resolved.searchMaxResults, resolved.searchTimeoutMs, resolved.fetch, { enabled: resolved.searxngEnabled, url: resolved.searxngUrl });
    }
    if (resolved.fetch) {
